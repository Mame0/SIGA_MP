...
<html>
	...
	<center><font style="color:#073A6B;font-weight: bold;"><?=$_POST['nomb_elec']?><BR><font style="font-size: 20;">FORMATO C<BR>DETENCIONES E INTERVENCIONES</font><br>USUARIO: <?=$_SESSION['logi_oper']?></font></center>
...
<?
	...
	$result=$Db->query("select * from mp_elec_detenciones WHERE codi_elec='".$_POST['codi_elec']."' AND codi_usua='".$_SESSION['logi_oper']."'");
	$busc_tota_item=0;
	foreach($result as $rows)
	{       
		$busc_tota_item++;
	...
	$result_pagi=$Db->query("select * from mp_elec_detenciones WHERE codi_elec='".$_POST['codi_elec']."' AND codi_usua='".$_SESSION['logi_oper']."' order by fdig_dete limit $busc_limi_pagi,$busc_item_pagi");
	...
	$head=['1'=>"NRO.",'2'=>"TIPO",'3'=>"FECHA",'4'=>"UBICACION",'5'=>"EDIT",'6'=>"ACTA",'7'=>"FORM"];
	...
	if($busc_tota_item)
	{
		...
		foreach($result_pagi as $rows)
		{
			...
			$data=[	'1'=>$cont,
				...
				'5'=>"<a href=\"javascript:f_editar('$rows[codi_dete]')\"><img src=\"img/icons/edit.svg\" width=\"20\">",
				'6'=>"<a href=\"javascript:f_acta('$acta')\"><img src=\"$imag\" width=\"20\">",
				'7'=>"<a href=\"javascript:f_formato('$rows[codi_dete]')\"><img src=\"img/observatorio.png\" width=\"20\">",
			];
