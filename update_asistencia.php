...
// I will extract the array, modify it, and put it back.
// But it's easier to just do a string replacement on the exact block.

// We need to replace from `'1. CONTROL DE ASISTENCIA' =>` to the end of the `Boleta de Permiso` section, and re-insert the keys for `2. Compensación por trabajo...` with the exact text.
// Actually, I can just replace the whole `1. CONTROL DE ASISTENCIA` and all its sub-keys.
...
$replace = "  '1. CONTROL DE ASISTENCIA' => '1. Boleta de Permiso
2. Compensación por trabajo en sobretiempo por toda la jornada laboral
3. Autorización de ingreso en días de descanso obligatorio, feriados y días no laborables.
4. Récord de Asistencia
5. Fecha de cierre de asistencia
