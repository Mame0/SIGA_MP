...
<html>
	...
	<center><font style="color:#073A6B;font-weight: bold;"><?=$_POST['nomb_elec']?><BR><font style="font-size: 20;">FORMATO B<BR>ALERTAS U OCURRENCIAS</font><br>USUARIO: <?=$_SESSION['logi_oper']?></font></center>
...
<?
	...
	$result=$Db->query("select codi_aler,codi_tale,fech_aler,ubig_aler from mp_elec_alertas WHERE codi_elec='".$_POST['codi_elec']."' AND codi_usua='".$_SESSION['logi_oper']."'");
	$busc_tota_item=0;
	foreach($result as $rows)
	{       
		$busc_tota_item++;
	...
	$result_pagi=$Db->query("select codi_aler,codi_tale,fech_aler,ubig_aler,esta_aler from mp_elec_alertas WHERE codi_elec='".$_POST['codi_elec']."' AND codi_usua='".$_SESSION['logi_oper']."' order by codi_aler limit $busc_limi_pagi,$busc_item_pagi");
	...
	$head=['1'=>"NRO.",'2'=>"TIPO",'3'=>"FECHA",'4'=>"UBICACION",'5'=>"EDIT",'6'=>"LESI",'7'=>"ACTA",'8'=>"FORM"];
	...
	if($busc_tota_item)
	{
		...
		foreach($result_pagi as $rows)
		{
			...
			$data=[	'1'=>$del.$cont,
				...
				'5'=>"<a href=\"javascript:f_editar('$rows[codi_aler]')\"><img src=\"img/icons/edit.svg\" width=\"20\">",
				'6'=>"<a href=\"javascript:f_lesionados('$rows[codi_aler]')\"><img src=\"img/icons/user.svg\" width=\"20\">",
				'7'=>"<a href=\"javascript:f_acta('$acta')\"><img src=\"$imag\" width=\"20\">",
				'8'=>"<a href=\"javascript:f_formato('$rows[codi_aler]')\"><img src=\"img/observatorio.png\" width=\"20\">",
			];
