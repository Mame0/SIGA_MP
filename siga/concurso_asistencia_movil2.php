...
//echo"<script>alert('EOK ".$_POST['codi_post']."')</script>";
        $fdig=date("YmdHis");
	    if($_POST['codi_post'] AND $veri_dupl<2)
	    {
	        ...
	        echo"<script>
	            //getElementById('div-mensajes').style.background='#45BE00';
	            getElementById('div-mensajes').innerHTML = '$mens_post_agre';
	            setTimeout(function(){
                    getElementById('div-mensajes').innerHTML ='';
                    //getElementById('div-mensajes').style.background='#073A6B';
                }, 6000);
	        </script>";  
	    }
	    else
	    {
	        ...
	        echo"<script>
	            //getElementById('div-mensajes').style.background='#FF0000';
	            getElementById('div-mensajes').innerHTML = '<FONT COLOR=SILVER><U>ERROR</U>:</FONT> $mens';
	            setTimeout(function(){
                    getElementById('div-mensajes').innerHTML ='';
                    //getElementById('div-mensajes').style.background='#073A6B';
                }, 6000);
...
<?
	...
	echo"<BR><BR><div id=\"div-mensajes\" align=\"center\"></div>";
