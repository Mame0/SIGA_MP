<?
	...
	{
	    if($_POST['fech_difu'])
	        $_POST['fech_difu']=substr($_POST['fech_difu'],0,4).substr($_POST['fech_difu'],5,2).substr($_POST['fech_difu'],8,2);
		if($_POST['codi_difu'])
		{
			$result=$Db->update('mp_elec_difusion',['codi_elec'=>$_POST['codi_elec'],'codi_usua'=>$_SESSION['logi_oper'],'codi_tdif'=>$_POST['codi_tdif'],'fech_difu'=>$_POST['fech_difu'],'ubig_difu'=>$_POST['ubig_difu'],'obse_difu'=>$_POST['obse_difu'],'digi_difu'=>$_SESSION['iden_oper'],'fdig_difu'=>"$fdig",'esta_difu'=>'1'],['codi_difu'=>$_POST['codi_difu']]);
		}
		else
		{
			$result=$Db->insert('mp_elec_difusion',['codi_elec'=>$_POST['codi_elec'],'codi_usua'=>$_SESSION['logi_oper'],'codi_tdif'=>$_POST['codi_tdif'],'fech_difu'=>$_POST['fech_difu'],'ubig_difu'=>$_POST['ubig_difu'],'obse_difu'=>$_POST['obse_difu'],'digi_difu'=>$_SESSION['iden_oper'],'fdig_difu'=>"$fdig",'esta_difu'=>'1']);
			$_POST['codi_part']=$Db->lastInsertId();
		}
		if($_POST['regresar_reporte'])
		    $dire="elecciones_difusion.php";
		else
		    $dire="elecciones_difusion_nuevo.php";
		echo"
...
<html>
	...
	<center><font style="color:#073A6B;font-weight: bold;"><?=$_POST['nomb_elec']?><BR><font style="font-size: 20;">REGISTRAR NUEVA DIFUSION</font><br>USUARIO: <?=$_SESSION['logi_oper']?></font></center>
...
<?
	...
	echo $html->put_select("Tipo",'codi_tdif',$arra_options_tdif,$_POST['codi_tdif'],"");
	echo $html->put_select("Ubicaci&oacute;n",'ubig_difu',$arra_options_prov,$_POST['ubig_difu'],"");
	echo $html->put_text('date',"Fecha","Ingrese Fecha ",'fech_difu',$_POST['fech_difu'],'','8',' onchange="return solonumeros(this.value)"');
    echo $html->put_title_demand("Observaciones");
    echo $html->put_textarea("",'obse_difu',$_POST['obse_difu'],'style="height: 100px;"');
	echo"</main>";
