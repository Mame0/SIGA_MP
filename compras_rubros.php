...
<html>
	<head>
		...
		<script>
			function f_editar(codi)
			{
				...
				document.form.action='compras_rubros_registro.php';
	...
	<center><h2 style="color:#073A6B">RUBROS / ACTIVIDADES COMERCIALES</h2></center>
...
<?
	...
	$result=$Db->query("select * from mp_maes_comp_rubro ");
	$busc_tota_item=0;
	...
	$result_pagi=$Db->query("select mp_maes_comp_rubro.*
	from mp_maes_comp_rubro
	order by x_nombre limit $busc_limi_pagi,$busc_item_pagi");

	echo"<div style=\"width:90%;max-width:800px;margin:auto;\">";
	echo $html->put_title_demand("RUBROS / ACTIVIDADES COMERCIALES: $busc_tota_item ENCONTRADOS");
	if($busc_tota_pagi>0)
		echo $html->put_page("1",$_POST['busc_pagi_actu'],$busc_tota_pagi,"");
	$head=['1'=>"#",'2'=>"RUBRO / ACTIVIDAD COMERCIAL",'3'=>"ACTIVO",'4'=>"EDITAR"];
	...
	if($busc_tota_item)
	{
		...
		echo $html->put_table_responsive_title("No existen rubros / actividades comerciales registradas");
