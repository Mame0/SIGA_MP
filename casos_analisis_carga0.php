...
var myPieChart = new Chart(ctx, {
  type: 'pie',
  data: {
	labels: ['DENUNCIA PENDIENTE', 'CALIFICACION', 'INVESTIGACION PRELIMINAR', 'INVESTIGACION PREPARATORIA'],
	datasets: [
		{
			label: 'Dataset 1',
			data: [<? echo $cant1; ?>,<? echo $cant2; ?>,<? echo $cant3; ?>,<? echo $cant4; ?>],
			backgroundColor: ["<? echo $colores[1]; ?>","<? echo $colores[2]; ?>","<? echo $colores[3]; ?>","<? echo $colores[4]; ?>"],
		}
	],
  },
  options: {
