...
$tabla_maestra = 'mp_bienes_incautados_tipos_disposicion';
$titulo_pagina = 'Mantenimiento de Tipos de Disposición';
$url_retorno = 'admin_bienes_incautados_tipos.php';
...
<body>
    ...
    <form name="form_maestro" method="post" action="<?php echo $url_retorno; ?>">
        ...
        <?php
        echo $html->put_title_demand("Datos del Tipo de Disposición");
        echo "<main style='column-count:2;'>";
        echo $html->put_text('text', 'Nombre del Tipo', 'Ingrese el nombre', 'nombre', $edit_data['nombre'], '1', '100', 'required');
        echo $html->put_checkbox('Activo', 'activo', $edit_data['activo'], '', 'Marcar si el tipo está activo');
        echo "</main>";
        ?>
    ...
    $tipos = $Db->select($tabla_maestra, [], '', '', ['nombre' => 'ASC']);

    echo $html->put_table_responsive_open();
    echo $html->put_table_responsive_title("Listado de Tipos de Disposición");
    ...
    foreach ($tipos as $tipo) {
        ...
        $data['activo'] = $tipo['activo'] ? '<font color="green">SI</font>' : '<font color="red">NO</font>';
        $data['acciones'] = '<a href="'.$url_retorno.'?edit='.$tipo['id'].'">Editar</a>';
