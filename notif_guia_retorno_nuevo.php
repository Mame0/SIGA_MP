...
<html>
	<head>
		...
		<script>
			...
			function f_cancelar()
			{
				document.form.action='notif_asignacion.php';
				document.form.submit();
			}
...
<?
    ...
    echo $html->put_title_demand("Ingrese Informaci&oacute;n");
    echo $html->put_select("Mensajero",'codi_tema',$arra_options_tema,$_POST['codi_tema'],"");
    echo $html->put_select("Zona",'codi_tema',$arra_options_tema,$_POST['codi_tema'],"");
    echo $html->put_text('text',"Código&nbsp;de&nbsp;Documento","Ingrese Código",'dire_docu',$_POST['dire_docu'],'','200','');
                        ...
                        <div align=center class=\"foot\">
                                ...
                                <div align=center class=\"foot2\">
                                        ...
                                        <div class=\"div_button_foot\"><center>
                                                <button class=\"button_foot\" onclick=\"return f_guardar()\">Agregar Documento &raquo;</button>
                                        </div>
                                </div>
                        </div>
                ";
