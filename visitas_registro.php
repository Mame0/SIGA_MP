...
//classes/TCPDF/examples/personal_fotocheck.php
    ...
    if(!empty($_POST['ndoc_visi']) AND $_POST['tipo_regi']==2)  //si se debe guardar el formulario completo
    {
        ...
        if(!empty($_POST['iden_visi'])) //update
            $result=$Db->update("mp_visi_registro",['appa_visi'=>$_POST['appa_visi'],'apma_visi'=>$_POST['apma_visi'],'nomb_visi'=>$_POST['nomb_visi'],'tipo_visi'=>$_POST['tipo_visi'],'iden_depe'=>$_POST['iden_depe'],'iden_pers'=>$_POST['iden_pers'],'piso_visi'=>$_POST['piso_visi'],'obse_visi'=>$_POST['obse_visi']],['iden_visi'=>$_POST['iden_visi']]);
        else
            $result=$Db->insert("mp_visi_registro",['tdoc_visi'=>$_POST['tdoc_visi'],'ndoc_visi'=>$_POST['ndoc_visi'],'nomb_visi'=>$_POST['nomb_visi'],'appa_visi'=>$_POST['appa_visi'],'apma_visi'=>$_POST['apma_visi'],'tipo_visi'=>$_POST['tipo_visi'],'fech_visi'=>$fech,'ingr_visi'=>$hora,'sali_visi'=>'','iden_loca'=>$_POST['codi_loca'],'iden_depe'=>$_POST['iden_depe'],'iden_pers'=>$_POST['iden_pers'],'piso_visi'=>$_POST['piso_visi'],'iden_empr'=>$_POST['iden_empr'],'obse_visi'=>$_POST['obse_visi'],'digi_visi'=>$_SESSION['iden_oper'],'fdig_visi'=>$fdig,'esta_visi'=>'1']);
	...
	if(!empty($mensaje))
	{
	    if(!isset($color_mensaje)) $color_mensaje = '#45BE00';
	    echo"<script>
	            parent.document.getElementById('header').style.background='$color_mensaje';
...
<?
	...
	if($_POST['ndoc_visi'] OR $_POST['iden_visi'])     //SI ES QUE NO SE HA ENCONTRADO EL VISITANTE SE MUESTRA EL FORMULARIO DE REGISTRO
	{
	    if($_POST['iden_visi'])
	    {
    	...
    	if($busc_tota_item OR 5==5)
    	{
    		...
    		foreach($result_pagi as $rows)
	    	{
		    	...
		    	$data=[	'1'=>$cont,
		    		...
		    		'5'=>"<table class=\"tabla2\"><tr><td><img src=\"img/icons/download.svg\" width=\"20\"></td><td style=\"color:#008000;font-weight:bold;\">".$rows['ingr_visi']."</td></tr><tr><td><img src=\"img/icons/upload.svg\" width=\"20\"></td><td style=\"color:".($rows['sali_visi']=='00:00:00'?'#888888':'#0056b3').";font-weight:bold;\">".$rows['sali_visi']."</td></tr></table>",
